...
def get_dataloaders(input_paths, target_paths, batch_size, num_class):
    ...
    if num_class == 3:
       transform_target = transforms.Compose(
           [transforms.ToTensor(), transforms.Resize((352, 352), interpolation=transforms.InterpolationMode.NEAREST)]
       )
